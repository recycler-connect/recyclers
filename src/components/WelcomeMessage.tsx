...
const WelcomeMessage = () => {
  return (
    <div className="welcome-message">
      ...
      <p>
        By using this tool, you&apos;re taking a step towards promoting sustainable textile waste
        management and circular economies. Let&apos;s work together to make every thread count in
